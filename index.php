...
<head>
    ...
    <!--====== Title ======-->
    <title> Bank Code Finder Portal | Home</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                           <h3 style="color: red;padding-right: 50px;"> Bank Code Finder Portal</h3>
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(assets/images/footer-bg.jpg)">
        <div class="container">
            <div class="footer-copyright text-center">
                <p class="text">© <?php echo date('Y');?> Bank Code finder Portal</p>
            </div>
        </div> <!-- container -->
    </footer>
